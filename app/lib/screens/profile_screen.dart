      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            _SettingItem(icon: Icons.volume_up, title: 'TTS 음성', subtitle: 'de-DE (시스템 보이스)'),
            _SettingItem(icon: Icons.public, title: '변종', subtitle: '표준 몽골어 (Улаанбаатар) · Монгол хэл'),
            _SettingItem(icon: Icons.palette, title: '테마', subtitle: '낮 · Schwarz-Rot-Gold #DD0000'),
          ]),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: '저작권', subtitle: '몽골어유니버스 · 2026'),
          ]),
